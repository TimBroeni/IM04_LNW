...
│   ├── add_toy.php                             ← Spielzeug hinzufügen
│   ├── auth.php                                ← Session-Status prüfen
│   ├── dashboard.php                           ← Dashboard-Daten laden
│   ├── household.php                           ← Haushalt verwalten
│   ├── login.php                               ← Login verarbeiten
│   ├── logout.php                              ← Session beenden
│   ├── name_toy.php                            ← Spielzeug umbenennen
│   ├── new_box.php                             ← Neue Kiste hinzufügen
│   ├── newhousehold.php                        ← Neuen Haushalt erstellen
│   ├── profil.php                              ← Profildaten laden
│   ├── profilUpdate.php                        ← Profil aktualisieren
│   ├── register.php                            ← Registrierung verarbeiten
│   ├── settings.php                            ← Einstellungen speichern
│   ├── toy.php                                 ← Spielzeugdaten laden
│   └── toyUpdate.php                           ← Spielzeug aktualisieren
├── css                                         
│   ├── desktop.css                             ← Desktop-Layout
│   ├── master.css                              ← Globale Basisstile
│   └── mobile.css                              ← Mobile Darstellung
├── images                                     
│   ├── nav                                     
│   │   ├── nav_gifts.svg                       ← Icon für Belohnungen
│   │   ├── nav_home.svg                        ← Icon für Startseite
│   │   ├── nav_points.svg                      ← Icon für Punkte
│   │   ├── nav_settings.svg                    ← Icon für Einstellungen
│   │   └── nav_toys.svg                        ← Icon für Spielzeuge
│   ├── DEMO_toy_loeschen.png                   ← Demo für Löschen
│   ├── DEMO_toy_update.png                     ← Demo für Bearbeiten
│   ├── sortino_bildmarke.png                   ← Bildmarke von Sortino
│   ├── sortino_favicon.png                     ← Favicon der WebApp
│   ├── sortino_marke.png                       ← Markenlogo von Sortino
│   └── sortino_textmarke.png                   ← Textlogo von Sortino
├── js                                          
│   ├── add_toy.js                              ← Spielzeug hinzufügen
│   ├── auth.js                                 ← Authentifizierung prüfen
│   ├── dashboard.js                            ← Dashboard steuern
│   ├── data.js                                 ← Gemeinsame Datenladefunktionen
│   ├── join_household.js                       ← Haushalt beitreten
│   ├── login.js                                ← Login-Formular steuern
│   ├── logout.js                               ← Logout ausführen
│   ├── name_toy.js                             ← Spielzeugname ändern
│   ├── new_box.js                              ← Kiste anlegen
│   ├── new_household.js                        ← Haushalt anlegen
│   ├── profil.js                               ← Profilseite steuern
│   ├── register.js                             ← Registrierung steuern
│   ├── settings.js                             ← Einstellungen steuern
│   └── toy.js                                  ← Spielzeugseite steuern
├── pysical                                     ← Alles für den Microcontroller
│   ├── 3D Druck
...
│   ├── ScreenFlow.png
│   └── Steckplan.png
├── system                                      ← System- und Datenbankdateien
│   ├── config.php                              ← Datenbankkonfiguration
│   ├── config.php.blank                        ← Vorlage für config.php
│   └── db.sql                                  ← Datenbankschema
├── .gitattributes
├── .gitignore
├── add_toy.html                                ← Seite zum Hinzufügen
├── household.html                              ← Haushaltsübersicht
├── index.html                                  ← Einstiegsseite
├── join_household.html                         ← Seite zum Beitritt
├── login.html                                  ← Login-Seite
├── name_toy.html                               ← Seite zum Umbenennen
├── new_box.html                                ← Seite zum Kiste anlegen
├── new_household.html                          ← Seite zum Haushalt anlegen
├── profil.html                                 ← Profilseite
├── README.md                                   ← Github ReadMe
├── register.html                               ← Registrierungsseite
├── settings.html                               ← Einstellungsseite
└── toys.html                                   ← Spielzeugübersicht
```
